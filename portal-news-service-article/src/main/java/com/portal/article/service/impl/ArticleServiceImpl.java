...
//        doDeleteArticleHTML(articleId);
    ...
    private void doDeleteArticleHTML(String articleId) {
        String url = "http://html.portalnews.com:8002/article/html/delete?articleId=" + articleId;

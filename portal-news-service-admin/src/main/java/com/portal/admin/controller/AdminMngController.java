...
import com.portal.admin.service.AdminUserService;
import com.portal.api.BaseController;
import com.portal.api.controller.admin.AdminMngControllerApi;
import com.portal.enums.FaceVerifyType;
...
import com.portal.pojo.bo.AdminLoginBO;
import com.portal.pojo.bo.NewAdminBO;
import com.portal.utils.FaceVerifyUtils;
...
public class AdminMngController extends BaseController implements AdminMngControllerApi {
    ...
    public GraceJSONResult adminFaceLogin(AdminLoginBO adminLoginBO,
        ...
        String fileServerUrlExecute
                = "http://files.portalnews.com:8004/fs/readFace64InGridFS?faceId=" + adminFaceId;

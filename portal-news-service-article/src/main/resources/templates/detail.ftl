        ...
        <div class="white-bar">
            <div class="left-part">
                <div class="logo-wrapper" @click="goIndex()">
                    <!-- <img src="./img/portal-news-logo.png" class="big-logo"/> -->
                    <img src="../img/portal-news-logo.png" class="big-logo"/>
                </div>
                ...
                <div class="menus">
                    ...
                    <div class="single-default">
                        <a href="https://class.portal.com/sale/javaarchitect" target="_blank" class="white-header-left">架构师</a>
                    </div>
                </div>
            </div>
        ...
        <div class="detail-really">
            ...
            <div class="left-social">
                ...
                <div class="portal-words">
                    <span class="portal-num">慕课媒体号</span>
                </div>
